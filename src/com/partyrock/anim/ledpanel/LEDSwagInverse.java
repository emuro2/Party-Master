...
public class LEDSwagInverse extends ElementAnimation
{
    ...
    public LEDSwagInverse(LightMaster master, int startTime, ArrayList<ElementController> elementList, double duration) {
    ...
    public void increment(double percentage) {
        ...
        for (ElementController controller : getElements()) {
            ...
            if (num < 16) {
                ...
                for (int r = fadedRows + 1; r <= 8 &&  r < panel.getPanelHeight()/2; r++) {
                    ...
                    for (int c = 0; c < panel.getPanelWidth()/2; c++) {
                        ...
                        panel.setColor(r+panel.getPanelHeight()/2, c+ panel.getPanelWidth()/2, color1);
                        panel.setColor(c+panel.getPanelWidth()/2, r+panel.getPanelWidth()/2, color);
                        
                        panel.setColor(r+panel.getPanelHeight()/2, c, color);
                        panel.setColor(c+panel.getPanelWidth()/2, r, color1);
                        
                        
                        panel.setColor(r, c+ panel.getPanelWidth()/2, color1);
                        panel.setColor(c, r+panel.getPanelWidth()/2, color);
                    	}
                    	else{
                    	
                        panel.setColor(r, c, color1);
                        panel.setColor(c, r, color);
                            //panel.setColor(r, r, getRandomColor());
                        ...
                        panel.setColor(r+panel.getPanelHeight()/2, c, color1);
                        panel.setColor(c+panel.getPanelWidth()/2, r, color);
